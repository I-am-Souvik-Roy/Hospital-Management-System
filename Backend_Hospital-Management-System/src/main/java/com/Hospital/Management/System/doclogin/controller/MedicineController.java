...
public class MedicineController{
	...
	public ResponseEntity<java.util.Map<String,Boolean>> delete(@PathVariable long id) throws AttributeNotFoundException {
		Medicine medicine=medicineRepository.findById(id).orElseThrow(()-> new AttributeNotFoundException("Medicine Not Found with id"+id));
		medicineRepository.delete(medicine);
		java.util.Map<String,Boolean> response =new HashMap<String, Boolean>();
